...
const chapters = [
  ...
  { name: "YPO Cairo Integrated",                type: "YPO",      CC:"trained",       LO:"trained",       ALO:"trained",     FO:"trained",       MO:"trained",       MEO:"unregistered" },
  { name: "YPO Capital Pakistan Integrated",     type: "YPO",      CC:"trained",         LO:"trained",       ALO:"trained",     FO:"trained",       MO:"trained",       MEO:"unregistered" },
  { name: "YPO Dubai Downtown Integrated",       type: "YPO",      CC:"trained",       LO:"trained",       ALO:"trained",       FO:"trained",       MO:"trained",     MEO:"trained"      },
  { name: "YPO Dubai Integrated",               type: "YPO",      CC:"trained",       LO:"trained",     ALO:"trained",       FO:"trained",       MO:"unregistered",  MEO:"unregistered" },
  ...
  { name: "YPO Gold Pakistan",                  type: "YPO Gold", CC:"untrained",     LO:"trained",       ALO:"trained",       FO:"trained",       MO:"unregistered",  MEO:"trained"      },
  { name: "YPO Gold Saudi",                     type: "YPO Gold", CC:"unregistered",  LO:"trained",       ALO:"unregistered",  FO:"unregistered",  MO:"unregistered",  MEO:"trained"      },
  ...
  { name: "YPO Khaleej Integrated",             type: "YPO",      CC:"trained",       LO:"trained",       ALO:"trained",     FO:"trained",       MO:"trained",       MEO:"trained"      },
  { name: "YPO Kuwait Integrated",              type: "YPO",      CC:"trained",       LO:"trained",       ALO:"trained",       FO:"missed",       MO:"trained",     MEO:"null" },
  { name: "YPO Lebanon",                        type: "YPO",      CC:"trained",       LO:"trained",       ALO:"trained",     FO:"trained",       MO:"trained",       MEO:"unregistered" },
  ...
  { name: "YPO Oman Integrated",                type: "YPO",      CC:"trained",       LO:"trained",       ALO:"trained",       FO:"trained",       MO:"missed",     MEO:"trained"      },
  { name: "YPO Pakistan",                       type: "YPO",      CC:"trained",       LO:"trained",       ALO:"trained",     FO:"trained",       MO:"trained",       MEO:"unregistered" },
...
const locationData = {
  ...
  "YPO Cairo Integrated":                { CC:{loc:"Virtual",status:"completed",session:"Chapter Chair Integrated Workshop - 2"}, LO:{loc:"Virtual",status:"completed",session:"Learning Officer Workshop - 1"}, ALO:{loc:"Virtual",status:"completed",session:"Assistant Learning Officer Workshop - 3"}, FO:{loc:"Virtual",status:"completed",session:"Forum Officer Workshop - 2"}, MO:{loc:"Virtual",status:"completed",session:"Membership Officer Workshop - 1"}, MEO:{loc:"unregistered",status:"unregistered"} },
  "YPO Capital Pakistan Integrated":     { CC:{loc:"Virtual",status:"completed",session:"Chapter Chair YPO Workshop - 2"}, LO:{loc:"Virtual",status:"completed",session:"Learning Officer Workshop - 3"}, ALO:{loc:"Virtual",status:"completed",session:"Assistant Learning Officer Workshop - 3"}, FO:{loc:"Sydney",status:"completed",session:"Chapter Forum Officer Workshop"}, MO:{loc:"Previously Trained",status:"prev_trained",session:"Trained prior to 2026 GLC cycle"}, MEO:{loc:"unregistered",status:"unregistered"} },
  "YPO Dubai Downtown Integrated":       { CC:{loc:"Virtual",status:"completed",session:"Chapter Chair Integrated Workshop - 2"}, LO:{loc:"Virtual",status:"completed",session:"Learning Officer (Fast Track) Workshop - 1"}, ALO:{loc:"Chicago",status:"completed",session:"Chapter Assistant Learning Officer Workshop - B"}, FO:{loc:"Virtual",status:"completed",session:"Forum Officer Workshop - 2"}, MO:{loc:"Virtual",status:"completed",session:"Membership Officer Workshop - 3"}, MEO:{loc:"Virtual",status:"completed",session:"Member Engagement Officer Workshop - 3"} },
  ...
  "YPO Gold Pakistan":                  { CC:{loc:"Virtual",status:"upcoming",session:"Chapter Chair Gold Workshop - 2"}, LO:{loc:"Virtual",status:"completed",session:"Learning Officer Workshop - 3"}, ALO:{loc:"Chicago",status:"completed",session:"Chapter Assistant Learning Officer Workshop - A"}, FO:{loc:"Virtual",status:"completed",session:"Forum Officer Workshop - 3"}, MO:{loc:"unregistered",status:"unregistered"}, MEO:{loc:"Virtual",status:"completed",session:"Member Engagement Officer Workshop - 3"} },
  "YPO Gold Saudi":                     { CC:{loc:"unregistered",status:"unregistered"}, LO:{loc:"Virtual",status:"completed",session:"Learning Officer Workshop - 1"}, ALO:{loc:"unregistered",status:"unregistered"}, FO:{loc:"unregistered",status:"unregistered"}, MO:{loc:"unregistered",status:"unregistered"}, MEO:{loc:"Sydney",status:"completed",session:"Chapter Member Engagement Officer Workshop - YPO - A"} },
  ...
  "YPO Khaleej Integrated":             { CC:{loc:"Virtual",status:"completed",session:"Chapter Chair Integrated Workshop - 3"}, LO:{loc:"Virtual",status:"completed",session:"Learning Officer (Fast Track) Workshop - 2"}, ALO:{loc:"Virtual",status:"completed",session:"Assistant Learning Officer Workshop - 3"}, FO:{loc:"Virtual",status:"completed",session:"Forum Officer Workshop - 3"}, MO:{loc:"Virtual",status:"completed",session:"Membership Officer Workshop - 1"}, MEO:{loc:"Virtual",status:"completed",session:"Member Engagement Officer Workshop - 1"} },
  "YPO Kuwait Integrated":              { CC:{loc:"Virtual",status:"completed",session:"Chapter Chair Integrated Workshop - 3"}, LO:{loc:"Chicago",status:"completed",session:"Chapter Learning Officer Workshop - A"}, ALO:{loc:"Sydney",status:"completed",session:"Chapter Assistant Learning Officer Workshop - B"}, FO:{loc:"Virtual",status:"missed",session:"Advanced Forum Officer Workshop - 3"}, MO:{loc:"Virtual",status:"completed",session:"Membership Officer Workshop - 3"}, MEO:{loc:"null",status:"null"} },
  "YPO Lebanon":                        { CC:{loc:"Sydney",status:"completed",session:"Chapter Chair Workshop - YPO"}, LO:{loc:"Virtual",status:"completed",session:"Learning Officer (Fast Track) Workshop - 1"}, ALO:{loc:"Virtual",status:"completed",session:"Assistant Learning Officer Workshop - 3"}, FO:{loc:"Previously Trained",status:"prev_trained",session:"Trained prior to 2026 GLC cycle"}, MO:{loc:"Virtual",status:"completed",session:"Membership Officer Workshop - 1"}, MEO:{loc:"unregistered",status:"unregistered"} },
  "YPO Levant Integrated":              { CC:{loc:"Sydney",status:"completed",session:"Chapter Chair Workshop - Integrated"}, LO:{loc:"Virtual",status:"completed",session:"Learning Officer Workshop - 1"}, ALO:{loc:"Chicago",status:"completed",session:"Chapter Assistant Learning Officer Workshop - B"}, FO:{loc:"Virtual",status:"completed",session:"Forum Officer Workshop - 1"}, MO:{loc:"Previously Trained",status:"prev_trained",session:"Trained prior to 2026 GLC cycle"}, MEO:{loc:"unregistered",status:"unregistered"} },
  ...
  "YPO MENA One Regional Integrated":   { CC:{loc:"Sydney",status:"completed",session:"Chapter Chair Workshop - Integrated"}, LO:{loc:"Sydney",status:"completed",session:"Chapter Learning Officer Workshop"}, ALO:{loc:"Chicago",status:"completed",session:"Chapter Assistant Learning Officer Workshop - A"}, FO:{loc:"Virtual",status:"completed",session:"Forum Officer Workshop - 3"}, MO:{loc:"Sydney",status:"completed",session:"Chapter Membership Officer Workshop - YPO - A"}, MEO:{loc:"Virtual",status:"completed",session:"Member Engagement Officer Workshop - 1"} },
  "YPO Morocco Integrated":             { CC:{loc:"Virtual",status:"completed",session:"Chapter Chair Integrated Workshop - 1"}, LO:{loc:"Virtual",status:"completed",session:"Learning Officer (Fast Track) Workshop - 1"}, ALO:{loc:"Virtual",status:"completed",session:"Assistant Learning Officer Workshop - 1"}, FO:{loc:"Virtual",status:"completed",session:"Advanced Forum Officer Workshop - 3"}, MO:{loc:"Virtual",status:"completed",session:"Membership Officer Workshop - 1"}, MEO:{loc:"Virtual",status:"missed",session:"Member Engagement Officer Workshop - 3"} },
  ...
  "YPO Oman Integrated":                { CC:{loc:"Sydney",status:"completed",session:"Chapter Chair Workshop - Integrated"}, LO:{loc:"Virtual",status:"completed",session:"Learning Officer (Fast Track) Workshop - 2"}, ALO:{loc:"Chicago",status:"completed",session:"Chapter Assistant Learning Officer Workshop - A"}, FO:{loc:"Sydney",status:"completed",session:"Chapter Forum Officer Workshop"}, MO:{loc:"Virtual",status:"missed",session:"Membership Officer Workshop - 3"}, MEO:{loc:"Virtual",status:"completed",session:"Member Engagement Officer Workshop - 3"} },
  "YPO Pakistan":                        { CC:{loc:"Virtual",status:"completed",session:"Chapter Chair YPO Workshop - 2"}, LO:{loc:"Virtual",status:"completed",session:"Learning Officer (Fast Track) Workshop - 1"}, ALO:{loc:"Virtual",status:"completed",session:"Assistant Learning Officer Workshop - 3"}, FO:{loc:"Virtual",status:"completed",session:"Forum Officer Workshop - 3"}, MO:{loc:"Sydney",status:"completed",session:"Chapter Membership Officer Workshop - YPO - B"}, MEO:{loc:"unregistered",status:"unregistered"} },
  "YPO Palestine Integrated":           { CC:{loc:"Virtual",status:"completed",session:"Chapter Chair Integrated Workshop - 2"}, LO:{loc:"Virtual",status:"missed",session:"Learning Officer (Fast Track) Workshop - 3"}, ALO:{loc:"Virtual",status:"completed",session:"Assistant Learning Officer Workshop - 3"}, FO:{loc:"Virtual",status:"completed",session:"Forum Officer Workshop - 3"}, MO:{loc:"Virtual",status:"completed",session:"Membership Officer Workshop - 3"}, MEO:{loc:"Virtual",status:"completed",session:"Member Engagement Officer Workshop - 3"} },
  "YPO Qatar Integrated":               { CC:{loc:"Virtual",status:"completed",session:"Chapter Chair Integrated Workshop - 3"}, LO:{loc:"Virtual",status:"completed",session:"Learning Officer (Fast Track) Workshop - 2"}, ALO:{loc:"Previously Trained",status:"prev_trained",session:"Trained prior to 2026 GLC cycle"}, FO:{loc:"Virtual",status:"completed",session:"Forum Officer Workshop - 1"}, MO:{loc:"Sydney",status:"completed",session:"Chapter Membership Officer Workshop - YPO - A"}, MEO:{loc:"Virtual",status:"completed",session:"Member Engagement Officer Workshop - 3"} },
  "YPO Saudi":                           { CC:{loc:"Virtual",status:"completed",session:"Chapter Chair Integrated Workshop - 3"}, LO:{loc:"Virtual",status:"completed",session:"Learning Officer Workshop - 1"}, ALO:{loc:"Virtual",status:"completed",session:"Assistant Learning Officer Workshop - 3"}, FO:{loc:"Previously Trained",status:"prev_trained",session:"Trained prior to 2026 GLC cycle"}, MO:{loc:"Virtual",status:"completed",session:"Membership Officer Workshop - 3"}, MEO:{loc:"Virtual",status:"completed",session:"Member Engagement Officer Workshop - 3"} },
...
const roleData = {
  CC: {
    trained: [
      ...
      { chapter: "YPO Gold Lebanon", session: "Chapter Chair Integrated Workshop - 2", date: "13 Apr", location: "Virtual", prev: false },
  ...
  LO: {
    trained: [
      ...
      { chapter: "YPO Gold Lebanon", session: "Learning Officer (Fast Track) Workshop - 2", date: "16 Apr", location: "Virtual", prev: false },
      { chapter: "YPO Khaleej Integrated", session: "Learning Officer (Fast Track) Workshop - 2", date: "16 Apr", location: "Virtual", prev: false },
      ...
      { chapter: "YPO Oman Integrated", session: "Learning Officer (Fast Track) Workshop - 2", date: "16 Apr", location: "Virtual", prev: false },
      { chapter: "YPO Pakistan", session: "Learning Officer (Fast Track) Workshop - 1", date: "31 Mar", location: "Virtual", prev: false },
      { chapter: "YPO Qatar Integrated", session: "Learning Officer (Fast Track) Workshop - 2", date: "16 Apr", location: "Virtual", prev: false },
      ...
      { chapter: "YPO Capital Pakistan Integrated", session: "Learning Officer Workshop - 3", date: "28 Apr", location: "Virtual", prev: false },
      { chapter: "YPO Gold Pakistan", session: "Learning Officer Workshop - 3", date: "28 Apr", location: "Virtual", prev: false },
      { chapter: "YPO Gold Saudi", session: "Learning Officer Workshop - 1", date: "30 Apr", location: "Virtual", prev: false },
    ],
    awaiting: [
    ...
    missed: [
      { chapter: "YPO Palestine Integrated", session: "Learning Officer (Fast Track) Workshop - 3", date: "19 May", location: "Virtual" },
    ],
  },
  ALO: {
    trained: [
    ...
    awaiting: [
      { chapter: "YPO Cairo Integrated", session: "Assistant Learning Officer Workshop - 2", date: "21 Apr", location: "Virtual", prev: false },
      ...
      { chapter: "YPO Gold Lebanon", session: "Assistant Learning Officer Workshop - 2", date: "21 Apr", location: "Virtual", prev: false },
      { chapter: "YPO Gold Pakistan", session: "Chapter Assistant Learning Officer Workshop - A", date: "Chicago: 26 Apr", location: "Chicago" },
      { chapter: "YPO Khaleej Integrated", session: "Assistant Learning Officer Workshop - 3", date: "21 May", location: "Virtual", prev: false },
      { chapter: "YPO Jordan Integrated", session: "Assistant Learning Officer Workshop - 3", date: "21 May", location: "Virtual", prev: false },
      { chapter: "YPO Lebanon", session: "Assistant Learning Officer Workshop - 3", date: "21 May", location: "Virtual", prev: false },
      ...
      { chapter: "YPO Pakistan", session: "Assistant Learning Officer Workshop - 3", date: "21 May", location: "Virtual", prev: false },
      { chapter: "YPO Palestine Integrated", session: "Assistant Learning Officer Workshop - 3", date: "21 May", location: "Virtual", prev: false },
      { chapter: "YPO Saudi", session: "Assistant Learning Officer Workshop - 3", date: "21 May", location: "Virtual", prev: false },
    ],
    missed: [
      { chapter: "YPO Capital Pakistan Integrated", session: "Assistant Learning Officer Workshop - 1", date: "25 Mar", location: "Virtual", prev: false },
      { chapter: "YPO Indus Integrated", session: "Assistant Learning Officer Workshop - 1", date: "25 Mar", location: "Virtual", prev: false },
    ],
  },
  FO: {
    trained: [
      ...
      { chapter: "YPO Gold Pakistan", session: "Forum Officer Workshop - 3", date: "19 May", location: "Virtual", prev: false },
      { chapter: "YPO Indus Integrated", session: "Forum Officer Workshop - 3", date: "19 May", location: "Virtual", prev: false },
      { chapter: "YPO Iraq Integrated", session: "Forum Officer Workshop - 3", date: "19 May", location: "Virtual", prev: false },
      { chapter: "YPO Jordan Integrated", session: "Forum Officer Workshop - 3", date: "19 May", location: "Virtual", prev: false },
      { chapter: "YPO Khaleej Integrated", session: "Forum Officer Workshop - 3", date: "19 May", location: "Virtual", prev: false },
      ...
      { chapter: "YPO MENA One Regional Integrated", session: "Forum Officer Workshop - 3", date: "19 May", location: "Virtual", prev: false },
      { chapter: "YPO Morocco Integrated", session: "Advanced Forum Officer Workshop - 3", date: "20 May", location: "Virtual", prev: false },
      ...
      { chapter: "YPO Pakistan", session: "Forum Officer Workshop - 3", date: "19 May", location: "Virtual", prev: false },
      { chapter: "YPO Palestine Integrated", session: "Forum Officer Workshop - 3", date: "19 May", location: "Virtual", prev: false },
  ...
  MO: {
    ...
    awaiting: [
      { chapter: "YPO Dubai Downtown Integrated", session: "Membership Officer Workshop - 3", date: "22 May", location: "Virtual", prev: false },
      { chapter: "YPO Jordan Integrated", session: "Membership Officer Workshop - 3", date: "22 May", location: "Virtual", prev: false },
      { chapter: "YPO Kuwait Integrated", session: "Membership Officer Workshop - 3", date: "22 May", location: "Virtual", prev: false },
      { chapter: "YPO Palestine Integrated", session: "Membership Officer Workshop - 3", date: "22 May", location: "Virtual", prev: false },
    ],
    missed: [
...
const STATUS = {
  ...
  untrained:    { bg: "#1565C0", text: "#fff", label: "Registered & Untrained",    icon: "◑" },
  unregistered: { bg: "#b82030", text: "#fff", label: "Unregistered",              icon: "✗" },
  missed:       { bg: "#d4881a", text: "#fff", label: "Missed Training",            icon: "⚠" },
  pending:      { bg: "#6b21a8", text: "#fff", label: "Pending Confirmation",       icon: "?" },
};
...
function LocCell({ cell, blank }) {
  ...
  const configs = {
    ...
    "Virtual-pending":    { bg:"#6b21a8", label:"VIR", badge:"?" },
...
function CombinedCell({ status, cell, blank, locFilter }) {
  ...
  const STATUS_ICONS = {
    trained: "✓", untrained: "◑", unregistered: "✗", missed: "⚠", pending: "?",
  };
  ...
  const getDateFromLoc = (loc, session) => {
    ...
    const virtualDates = {"Advanced Forum Officer Workshop - 2":"22 Apr 2026","Advanced Forum Officer Workshop - 3":"20 May 2026","Assistant Learning Officer Workshop - 1":"25 Mar 2026","Assistant Learning Officer Workshop - 2":"21 Apr 2026","Assistant Learning Officer Workshop - 3":"21 May 2026","Chapter Chair Integrated Workshop - 1":"24 Mar 2026","Chapter Chair Integrated Workshop - 2":"13 Apr 2026","Chapter Chair Integrated Workshop - 3":"6 May 2026","Chapter Chair YPO Workshop - 2":"10 Apr 2026","Chapter Chair Gold Workshop - 2":"26 May 2026","Forum Officer Workshop - 1":"10 Mar 2026","Forum Officer Workshop - 2":"7 Apr 2026","Forum Officer Workshop - 3":"19 May 2026","Learning Officer (Fast Track) Workshop - 1":"31 Mar 2026","Learning Officer (Fast Track) Workshop - 2":"16 Apr 2026","Learning Officer Workshop - 1":"19 Mar 2026","Learning Officer Workshop - 3":"12 May 2026","Member Engagement Officer Workshop - 1":"13 Mar 2026","Member Engagement Officer Workshop - 3":"20 Apr 2026","Membership Officer Workshop - 1":"11 Mar 2026","Membership Officer Workshop - 2":"15 Apr 2026","Membership Officer Workshop - 3":"22 May 2026"};
...
function RolesView({ allChapters }) {
  ...
  const getStats = (role) => {
    let trained = 0, untrained = 0, unregistered = 0, missed = 0, pending = 0;
    ...
    const applicable = trained + untrained + unregistered + missed + pending;
    return { trained, untrained, unregistered, missed, pending, applicable };
  };

  const roleOrder = ["CC", "LO", "ALO", "FO", "MO", "MEO"];
  const missedColor = "#d4881a";
  ...
  const rows = [
    ...
    { key: "pending",      label: "Pending Confirmation",   color: "#6b21a8", icon: "?" },
                ...
                {roleData[expandedRow.role].missed.map((item, idx) => {
                  ...
                  return (
                    <div key={idx} style={{
                      ...
                      borderBottom: idx < roleData[expandedRow.role].missed.length - 1 ? "1px solid #ffe0b0" : "none",
                    }}>
            ...
            {row.key === "unregistered" && expandedRow?.key === "unregistered" && (() => {
              ...
              return (
                <div style={{ background:"#fff", border:"1px solid #fbc8ce", borderTop:"none" }}>
                  <div style={{
                    display:"grid", gridTemplateColumns:"180px repeat(6, 1fr)",
                    background:"#fff3e0", padding:"8px 0", borderBottom:"1px solid #fbc8ce",
                  }}>
...
const nonCoreChapters = [
  ...
  { name: "YPO Capital Pakistan Integrated",     type: "YPO",      SPO:{s:"untrained",session:"Fam W3",date:"1 Jun"},   SFO:{s:"pending",session:"FO W3",date:"19 May"},                 Fam:"trained"                                },
  ...
  { name: "YPO Gold Lebanon",                   type: "YPO Gold", SPO:"trained",                               SFO:{s:"pending",session:"FO W3",date:"19 May"},                 Fam:"trained"                                },
  ...
  { name: "YPO MENA Gulf Regional Integrated",  type: "YPO",      SPO:"trained",                               SFO:{s:"pending",session:"FO W3",date:"19 May"},                 Fam:"trained"                                },
  ...
  { name: "YPO Morocco Integrated",             type: "YPO",      SPO:"null",                                  SFO:{s:"pending",session:"FO W3",date:"19 May"},                 Fam:"trained"                                },
  ...
  { name: "YPO UAE Integrated",                 type: "YPO",      SPO:"missed",                                SFO:{s:"pending",session:"FO W3",date:"19 May"},                 Fam:"trained"                                },
];
                ...
                {nonCoreRoles.map(r => {
                  ...
                  return (
                    <td key={r} style={{ padding:"6px 8px", textAlign:"center", borderRight:"1px solid #e8edf5" }}>
                      ...
                      ) : (status === "untrained" || status === "pending") && date ? (
                        <div style={{ display:"inline-flex", flexDirection:"column", alignItems:"center", gap:3 }}>
                          <div style={{ width:44, height:28, borderRadius:3, background:STATUS[status].bg, color:"#fff", display:"flex", alignItems:"center", justifyContent:"center", fontSize:13, fontWeight:700 }}>{STATUS[status].icon}</div>
                          <span style={{ fontSize:9, fontWeight:700, color:STATUS[status].bg, letterSpacing:"0.03em" }}>{date}</span>
                        </div>
                      ) : (
...
export default function App() {
  ...
  const isNonCoreBlank    = (ch, r) => (r==="MEO" && ch.type!=="YPO Gold" && (ch[r]==="unregistered" || ch[r]==="null")) || (r==="MO" && ch.type==="YPO Gold" && (ch[r]==="unregistered" || ch[r]==="null"));
    ...
    <div onClick={(e) => { if (!e.target.closest('.chapter-filter')) { setDropdownOpen(false); setLocDropdownOpen(false); } }} style={{ fontFamily:"'Neue Montreal','Plus Jakarta Sans','DM Sans',system-ui,sans-serif", background:"#f4f6fb", minHeight:"100vh" }}>
      ...
      <div style={{ background:"#fff", borderBottom:"1px solid #dde2ef", display:"flex", alignItems:"center", justifyContent:"space-between" }}>
        <div style={{ display:"flex" }}>
          {[["status","Training by Core Role"],["roles","Role Breakdown"]].map(([t,label]) => (
      ...
      {tab === "status" && (
        <div style={{ padding:"0 32px 28px", display:"flex", alignItems:"center", gap:20, flexWrap:"wrap" }}>
          {[
            ...
            { bg:"#6b21a8", icon:"?", label:"Pending Confirmation" },
