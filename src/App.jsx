...
const chapters = [
  ...
  { name: "YPO Gold Pakistan",                  type: "YPO Gold", CC:"untrained",     LO:"untrained",     ALO:"untrained",        FO:"trained",       MO:"unregistered",  MEO:"trained"      },
...
const locationData = {
  ...
  "YPO Gold Pakistan":                  { CC:{loc:"Virtual",status:"upcoming",session:"Chapter Chair Gold Workshop - 2"}, LO:{loc:"Virtual",status:"upcoming",session:"Learning Officer Workshop - 3"}, ALO:{loc:"Chicago",status:"upcoming",session:"Chapter Assistant Learning Officer Workshop - A"}, FO:{loc:"Previously Trained",status:"prev_trained",session:"Trained prior to 2026 GLC cycle"}, MO:{loc:"unregistered",status:"unregistered"}, MEO:{loc:"Virtual",status:"completed",session:"Member Engagement Officer Workshop - 3"} },
