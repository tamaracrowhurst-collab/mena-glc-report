...
const chapters = [
  ...
  { name: "YPO Gold Pakistan",                  type: "YPO Gold", CC:"untrained",     LO:"untrained",     ALO:"trained",       FO:"trained",       MO:"unregistered",  MEO:"trained"      },
  ...
  { name: "YPO Jordan Integrated",              type: "YPO",      CC:"trained",       LO:"trained",       ALO:"unregistered",  FO:"untrained",     MO:"untrained",     MEO:"unregistered" },
...
const locationData = {
  ...
  "YPO Gold Pakistan":                  { CC:{loc:"Virtual",status:"upcoming",session:"Chapter Chair Gold Workshop - 2"}, LO:{loc:"Virtual",status:"upcoming",session:"Learning Officer Workshop - 3"}, ALO:{loc:"Chicago",status:"completed",session:"Chapter Assistant Learning Officer Workshop - A"}, FO:{loc:"Previously Trained",status:"prev_trained",session:"Trained prior to 2026 GLC cycle"}, MO:{loc:"unregistered",status:"unregistered"}, MEO:{loc:"Virtual",status:"completed",session:"Member Engagement Officer Workshop - 3"} },
  "YPO Gold Saudi":                     { CC:{loc:"unregistered",status:"unregistered"}, LO:{loc:"Virtual",status:"upcoming",session:"Learning Officer Workshop - 3"}, ALO:{loc:"unregistered",status:"unregistered"}, FO:{loc:"unregistered",status:"unregistered"}, MO:{loc:"unregistered",status:"unregistered"}, MEO:{loc:"Sydney",status:"completed",session:"Chapter Member Engagement Officer Workshop - YPO - A"} },
  ...
  "YPO Jordan Integrated":              { CC:{loc:"Chicago",status:"completed",session:"Chapter Chair Workshop - Integrated"}, LO:{loc:"Virtual",status:"completed",session:"Learning Officer (Fast Track) Workshop - 1"}, ALO:{loc:"unregistered",status:"unregistered"}, FO:{loc:"Virtual",status:"upcoming",session:"Forum Officer Workshop - 3"}, MO:{loc:"Virtual",status:"upcoming",session:"Membership Officer Workshop - 3"}, MEO:{loc:"unregistered",status:"unregistered"} },
...
const roleData = {
  ...
  LO: {
    ...
    awaiting: [
      ...
      { chapter: "YPO Gold Pakistan", session: "Chapter Chair Gold Workshop - 2", date: "26 May", location: "Virtual" },
      { chapter: "YPO Gold Pakistan", session: "Learning Officer Workshop - 3", date: "12 May", location: "Virtual" },
      { chapter: "YPO Gold Saudi", session: "Learning Officer Workshop - 3", date: "12 May", location: "Virtual" },
    ],
    missed: [
    ...
    <div onClick={(e) => { if (!e.target.closest('.chapter-filter')) { setDropdownOpen(false); setLocDropdownOpen(false); } }} style={{ fontFamily:"'Neue Montreal','Plus Jakarta Sans','DM Sans',system-ui,sans-serif", background:"#f4f6fb", minHeight:"100vh" }}>
      ...
      <div style={{ background:"#fff", borderBottom:"1px solid #dde2ef", display:"flex", alignItems:"center", justifyContent:"space-between" }}>
        ...
        <div style={{ display:"flex", alignItems:"center", gap:16, padding:"0 32px" }}>
          ...
          <span style={{ fontSize:11, color:"#8892b0", fontWeight:500 }}>Data as of 07/05/2026</span>
        </div>
      </div>
