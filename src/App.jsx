...
const chapters = [
  ...
  { name: "YPO Kuwait Integrated",              type: "YPO",      CC:"missed",        LO:"trained",       ALO:"trained",       FO:"untrained",     MO:"untrained",     MEO:"unregistered" },
  ...
  { name: "YPO Pakistan",                       type: "YPO",      CC:"trained",       LO:"trained",       ALO:"untrained",     FO:"missed",        MO:"trained",       MEO:"unregistered" },
...
const locationData = {
  ...
  "YPO Kuwait Integrated":              { CC:{loc:"Chicago",status:"missed",session:"Chapter Chair Workshop - Integrated"}, LO:{loc:"Chicago",status:"completed",session:"Chapter Learning Officer Workshop - A"}, ALO:{loc:"Sydney",status:"completed",session:"Chapter Assistant Learning Officer Workshop - B"}, FO:{loc:"Virtual",status:"upcoming",session:"Advanced Forum Officer Workshop - 3"}, MO:{loc:"Virtual",status:"upcoming",session:"Membership Officer Workshop - 3"}, MEO:{loc:"unregistered",status:"unregistered"} },
  ...
  "YPO Pakistan":                        { CC:{loc:"Virtual",status:"completed",session:"Chapter Chair YPO Workshop - 2"}, LO:{loc:"Virtual",status:"completed",session:"Learning Officer (Fast Track) Workshop - 1"}, ALO:{loc:"Virtual",status:"upcoming",session:"Assistant Learning Officer Workshop - 3"}, FO:{loc:"Chicago",status:"missed",session:"Chapter Forum Officer Workshop - A"}, MO:{loc:"Sydney",status:"completed",session:"Chapter Membership Officer Workshop - YPO - B"}, MEO:{loc:"unregistered",status:"unregistered"} },
    ...
    <div onClick={(e) => { if (!e.target.closest('.chapter-filter')) { setDropdownOpen(false); setLocDropdownOpen(false); } }} style={{ fontFamily:"'Neue Montreal','Plus Jakarta Sans','DM Sans',system-ui,sans-serif", background:"#f4f6fb", minHeight:"100vh" }}>
      ...
      <div style={{ background:"#fff", borderBottom:"1px solid #dde2ef", display:"flex", alignItems:"center", justifyContent:"space-between" }}>
        ...
        <div style={{ display:"flex", alignItems:"center", gap:16, padding:"0 32px" }}>
          ...
          <span style={{ fontSize:11, color:"#8892b0", fontWeight:500 }}>Data as of 04/05/2026</span>
        </div>
      </div>
