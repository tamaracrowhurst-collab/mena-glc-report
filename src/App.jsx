...
const locationData = {
  ...
  "YPO Gold Pakistan":                  { CC:{loc:"Virtual",status:"upcoming",session:"Chapter Chair Gold Workshop - 2"}, LO:{loc:"Virtual",status:"completed",session:"Learning Officer Workshop - 3"}, ALO:{loc:"Chicago",status:"completed",session:"Chapter Assistant Learning Officer Workshop - A"}, FO:{loc:"Previously Trained",status:"prev_trained",session:"Trained prior to 2026 GLC cycle"}, MO:{loc:"unregistered",status:"unregistered"}, MEO:{loc:"Virtual",status:"completed",session:"Member Engagement Officer Workshop - 3"} },
